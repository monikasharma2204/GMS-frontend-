...
const MemoOutReturn = () => {
  ...
  useTransactionNavigationGuard(shouldShowUnsavedDialog, resetMemoOutReturnState);
  ...
  const handleExportExcel = () => {
    try {
      ...
      const summaryHeaders = [
        "Doc Date", "Due Date", "Memo Out Return No.", "Account", "Ref 1", "Ref 2",
      ...
      exportTransactionToExcel({
        filename: memoInfo?.invoice_no || "Memo Out Return",
        sheetName: "Memo Out Return",
        summaryHeaders,
        summaryValues,
        itemHeaders,
        itemRows,
  ...
  const restoreFromOriginalData = (data) => {
    ...
    setDocDate(parseBackendDate(data.doc_date));
    setDueDate(parseBackendDate(data.due_date));
    setRef1(data.ref_1 || "");
    setRef2(data.ref_2 || "");
