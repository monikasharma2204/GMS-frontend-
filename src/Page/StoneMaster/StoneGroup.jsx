...
const StoneGroup = () => {
      ...
      if (!savedId && formData?.code) {
        try {
          const response = await axios.get(
            `${API_URL}/master?master_type=master_stone_group&code=${encodeURIComponent(formData.code)}`
          );
  ...
  const endpointPath = "/master" + (method === "post" ? "?master_type=master_stone_group" : "");
