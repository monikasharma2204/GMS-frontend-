...
import CustomTextField from "./items/CustomTextField";
      ...
      <Box sx={{ marginTop: "16px", marginLeft: "30px" }}>
        ...
        >
          ...
          <Box sx={{ display: "flex" }}>
            <TextField
              value={formatNumberWithCommas(
                             Number(calculateTotalAfterDiscountPercent()).toFixed(2),
                           )}
              variant="outlined"
              fullWidth
              disabled
        ...
        >
          ...
          <Box sx={{ display: "flex" }}>
            <CustomTextField
                         ...
                         onChange={(value) =>
                           handleDiscountAmountChange({ target: { value } })
                         }
        ...
        >
          ...
          <Box sx={{ display: "flex" }}>
            <TextField
               value={formatNumberWithCommas(
                             Number(calculateTotalAfterVAT()).toFixed(2),
                           )}
              variant="outlined"
              fullWidth
              disabled
        ...
        >
          ...
          <Box sx={{ display: "flex" }}>
            <CustomTextField
                         ...
                         onChange={(value) =>
                           handleOtherChargeChange({ target: { value } })
                         }
                         disabled={disabled}
                         type="number"
                         decimal={2}
