...
export const selectedRowsState = atom({
  key: "quotationSelectedRowsState_Reserve",
  default: [], 
});
              ...
              >
                ...
                {loading ? (
                  ...
                  >
                    ...
                    <Box sx={{ width: "140px", display: "flex", alignItems: "center",  justifyContent: "center", padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.location_name}</Typography>
                    </Box>
                    <Box sx={{ width: "140px", display: "flex", alignItems: "center",  justifyContent: "center",padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.type}</Typography>
                    </Box>
                    <Box sx={{ width: "200px", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.stone_code}</Typography>
                    </Box>
                    <Box sx={{ width: "140px", display: "flex", alignItems: "center",  justifyContent: "center",padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.stock_id}</Typography>
                    </Box>
                    <Box sx={{ width: "120px", display: "flex", alignItems: "center",  justifyContent: "center",padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.lot_no}</Typography>
                    </Box>
                    <Box sx={{ width: "120px", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 8px" }}>
                      <Typography sx={textStyle}>{row.stone}</Typography>
                    </Box>
                    <Box sx={{ width: "100px", display: "flex", alignItems: "center", justifyContent: "center",padding: "12px 8px" }}>
                    ...
                    <Box sx={{ width: "100px", display: "flex", alignItems: "center", padding: "12px 8px", justifyContent: "center" }}>
                    ...
                    <Box sx={{ width: "140px", display: "flex", alignItems: "center", padding: "12px 8px", justifyContent: "center" }}>
                      <Typography sx={textStyle}>{row.cer_type}</Typography>
                    </Box>
                    <Box sx={{ width: "140px", display: "flex", alignItems: "center", padding: "12px 8px", justifyContent: "center", }}>
                      <Typography sx={textStyle}>{row.cer_no}</Typography>
                    </Box>
                    <Box sx={{ width: "60px", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px 8px" }}>
                    ...
                    <Box sx={{ width: "60px", display: "flex", alignItems: "center", padding: "12px 8px" ,justifyContent: "center"  }}>
