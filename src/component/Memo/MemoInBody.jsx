...
const genInvoiceNo = async () => {
  try {
    const data = await apiRequest("GET", "/inventory-in/get-invoice-no", {},{params:
      {
          ...
          >
            ...
            >
              ...
              >
                ...
                <Ref1 onRef1Change={onRef1Change} />
              <Ref2 onRef2Change={onRef2Change} />
              <Currency
