...
const TableRowComponent = (
  ({
    ...
    useEffect(() => {
      setImageError(false);
    }, [rows?.[index]?.image_preview, rows?.[index]?.image]);
        ...
        >
          ...
          >
            {(() => {
              ...
              if (rawSrc && typeof rawSrc === "string" && rawSrc.trim() !== "" && rawSrc.startsWith("/uploads/")) {
                rawSrc = `${API_URL}${rawSrc}`;
              }
              const src = rawSrc && typeof rawSrc === "string" && rawSrc.trim() !== "" ? rawSrc : null;
              if (src && !imageError) {
                return (
                  <img
                    src={src}
