...
const UserAndPermissionBody = ({ handleUserInput }) => {
  
  const [age, setAge] = React.useState(10);

  const handleChange = (event) => {
    setAge(event.target.value);
    if (handleUserInput) handleUserInput(); 
  };
        ...
        >
          <Box sx={{ display: "flex" }}>
            ...
            <Box sx={{ marginLeft: "64px", marginTop: "32px" }}>
              ...
              <Box>
                <NameUser onChange={handleUserInput} />
                <Departmant onChange={handleUserInput} />
              </Box>
            </Box>
          </Box>
        </Box>
          ...
          <Box>
            <Box>
              <Box sx={{ marginLeft: "248px" }}>
                <Box sx={{ display: "flex" }}>
                  <UsernameUser onChange={handleUserInput} />
                  <Box sx={{ marginLeft: "64px" }}>
                    <PasswordUser onChange={handleUserInput} />
                  </Box>
                </Box>
                <Box sx={{ display: "flex", marginTop: "24px" }}>
                  <PhoneNo onChange={handleUserInput} />
                  <Box sx={{ marginLeft: "64px" }}>
                    <Email onChange={handleUserInput} />
                  </Box>
                </Box>
              </Box>
