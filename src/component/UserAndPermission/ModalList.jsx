...
const NewTabDepartment = {
  ...
  marginTop: "12px",
  boxShadow:
    "0px 25px 37px 0px rgba(0, 0, 0, 0.10), 0px 10px 15px 0px rgba(0, 0, 0, 0.05)",
};
...
const TextHeader = {
  color: "var(--Colors-Grayscale-MainSectionTitle, #1D1D1F)",
  fontFamily: "Segoe UI",
  fontSize: "14px",
  fontStyle: "normal",
  fontWeight: 400,
...
const ModalList = () => {
  ...
  const [isBoxClickedName, setIsBoxClickedName] = useState(false);

  const handleBoxClickName = () => {
    setIsBoxClickedName(!isBoxClickedName);
  };

  const [isBoxClickedDepartment, setIsBoxClickedDepartment] = useState(false);

  const handleBoxClickDepartment = () => {
    setIsBoxClickedDepartment(!isBoxClickedDepartment);
  };

  const [isBoxClickedRole, setIsBoxClickedRole] = useState(false);

  const handleBoxClickRole = () => {
    setIsBoxClickedRole(!isBoxClickedRole);
  };
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Box onClick={handleBoxClickName} sx={subMenuName}>
                      <Box>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="20"
                        ...
                        >
                          <path
                            d="M11.6659 17.0827H8.33252C8.16743 17.0805 8.00971 17.014 7.89297 16.8972C7.77622 16.7805 7.70968 16.6228 7.70752 16.4577V9.99935L3.24919 3.90768C3.17872 3.81607 3.13581 3.70628 3.12548 3.59117C3.11515 3.47605 3.13783 3.36038 3.19086 3.25768C3.24398 3.15528 3.32406 3.06934 3.42246 3.00912C3.52086 2.94891 3.63383 2.91672 3.74919 2.91602H16.2492C16.3645 2.91672 16.4775 2.94891 16.5759 3.00912C16.6743 3.06934 16.7544 3.15528 16.8075 3.25768C16.8605 3.36038 16.8832 3.47605 16.8729 3.59117C16.8626 3.70628 16.8197 3.81607 16.7492 3.90768L12.2909 9.99935V16.4577C12.2887 16.6228 12.2222 16.7805 12.1054 16.8972C11.9887 17.014 11.8309 17.0805 11.6659 17.0827ZM8.95752 15.8327H11.0409V9.79102C11.0395 9.65812 11.0836 9.52876 11.1659 9.42435L14.9992 4.16602H4.99919L8.84919 9.42435C8.93141 9.52876 8.97551 9.65812 8.97419 9.79102L8.95752 15.8327Z"
                            fill="#343434"
                          />
                        </svg>
                      </Box>
                  ...
                  >
                    ...
                    <Box onClick={handleBoxClickDepartment} sx={subMenuName}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
                  ...
                  >
                    ...
                    <Box onClick={handleBoxClickRole} sx={subMenuName}>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
                ...
                <Box sx={{ ...NewTab }}>
                  ...
                  >
                    <Box sx={{ marginLeft: "16px" }}>
                      ...
                      >
                        <path
                          d="M2.5 13.334L5.83333 16.6673M5.83333 16.6673L9.16667 13.334M5.83333 16.6673V3.33398M16.6667 6.66732H12.5M12.5 8.33398V5.41732C12.5 4.86478 12.7195 4.33488 13.1102 3.94418C13.5009 3.55348 14.0308 3.33398 14.5833 3.33398C15.1359 3.33398 15.6658 3.55348 16.0565 3.94418C16.4472 4.33488 16.6667 4.86478 16.6667 5.41732V8.33398M12.5 11.6673H16.6667L12.5 16.6673H16.6667"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                    ...
                    <Typography sx={TextHeader}>Sort A-Z</Typography>
                  </Box>
                  <Box
                    sx={{
                      height: "44px",
                  ...
                  >
                    <Box sx={{ marginLeft: "16px" }}>
                      ...
                      >
                        <path
                          d="M2.5 13.334L5.83333 16.6673M5.83333 16.6673L9.16667 13.334M5.83333 16.6673V3.33398M12.5 3.33398H16.6667L12.5 8.33398H16.6667M12.5 16.6673V13.7507C12.5 13.1981 12.7195 12.6682 13.1102 12.2775C13.5009 11.8868 14.0308 11.6673 14.5833 11.6673C15.1359 11.6673 15.6658 11.8868 16.0565 12.2775C16.4472 12.6682 16.6667 13.1981 16.6667 13.7507V16.6673M16.6667 15.0007H12.5"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    <Typography sx={TextHeader}>Sort Z-A</Typography>
                  </Box>
                  <Box
                    sx={{
                      height: "44px",
                  ...
                  >
                    <Box sx={{ marginLeft: "16px" }}>
                      ...
                      >
                        <path
                          d="M0.141602 0.5H15.8583L10.0833 8.68083V15.5H5.9166V8.68083L0.141602 0.5ZM3.35827 2.16667L7.58327 8.1525V13.8333H8.4166V8.1525L12.6416 2.16667H3.35827ZM12.8999 9.22083L14.6666 10.9883L16.4349 9.22083L17.6133 10.3992L15.8458 12.1667L17.6133 13.935L16.4349 15.1133L14.6666 13.345L12.8999 15.1133L11.7208 13.9342L13.4883 12.1675L11.7208 10.3992L12.8999 9.22083Z"
                          fill="black"
                        />
                      </svg>
                    </Box>
                    <Typography sx={TextHeader}>
                      Clear Filter From "User Name"
                    </Typography>
                  </Box>
                </Box>
              )}
              {isBoxClickedDepartment && (
                <Box sx={{ ...NewTabDepartment }}>
                  <Box
                    sx={{
                      height: "44px",
                      bgcolor: "white",
