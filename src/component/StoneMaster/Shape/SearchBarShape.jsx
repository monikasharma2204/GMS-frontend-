...
const SearchBarShape = ({ onDataSelect, isEditing, selectedData }) => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        // include all items; we'll sort to keep inactive at bottom
  ...
  // Update selectedItemId when selectedData changes (for when data is refreshed)
  useEffect(() => {
