...
import Price from "../TextField/Disable/Price";

const LabourTypeBody = ({
  selectedData,
  isEditing,
  onCodeChange,
  onNameChange,
        ...
        >
          ...
          <Box sx={{ marginTop: "24px" }}>
            <Price
              ...
              onPricePcsChange={onPricePcsChange}
              onPriceCtsChange={onPriceCtsChange}
            />
          </Box>
