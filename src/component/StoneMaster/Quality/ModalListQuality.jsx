...
const ModalListQuality = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await apiRequest(
          "GET",
          "/master?master_type=master_stone_quality"
        );
        setData(response);
      } catch (err) {
        setError(err);
  ...
  const handleSwitchChange = (id) => async (event) => {
    ...
    try {
      ...
      await apiRequest("PUT", "/master?master_type=master_stone_quality", {
        _id: id,
...
export default ModalListQuality;
