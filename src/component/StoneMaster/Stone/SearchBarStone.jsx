...
const SearchBarStone = ({ onDataSelect, defaultGroupValue, isEditing, selectedData }) => {
  ...
  useEffect(() => {
    ...
    apiRequest("GET", "/master?master_type=master_stone_name")
      .then((response) => {
        // include all items; sort later to keep inactive at bottom
        setData(response || []);
        setLoading(false);
      })
      .catch((err) => {
