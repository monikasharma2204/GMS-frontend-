...
const SearchBarCertificateType = ({ onDataSelect, selectedData, isEditing }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        API_URL+"/master?master_type=master_certificate_type"
      )
      .then((response) => {
...
export default SearchBarCertificateType;
