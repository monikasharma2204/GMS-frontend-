...
import { payableBankImageModalOpenState, payableFormDataState, payableFSMState } from "../../../recoil/state/FinanceState";
...
const BankImageModal = () => {
  ...
  const [fsmState] = useRecoilState(payableFSMState);
