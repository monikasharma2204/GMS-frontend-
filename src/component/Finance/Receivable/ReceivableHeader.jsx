...
import { daybookOpenState, receivableValidationErrorState, receivableFSMState, receivableFormDataState } from "../../../recoil/state/FinanceState";
import apiRequest from "../../../helpers/apiHelper";
import CancelConfirmDialog from "./CancelConfirmDialog";
import SuccessModal from "../../Commons/SuccessModal";

const ReceivableHeader = () => {
  const setDaybookOpen = useSetRecoilState(daybookOpenState);
  const validationError = useRecoilValue(receivableValidationErrorState);
  ...
  const handleCancelReceivable = async (confirmed) => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: "12px", position: "relative" }}>
        ...
        >
          {fsmState === "view" ? "Cancel Receivable" : "Cancel"}
        </Button>
        <Button
