...
const ConsignmentCheckBodyInside = ({ selectedItem, onBack, exportTrigger }) => {
    ...
    const handleExportExcel = () => {
        try {
            ...
            const itemHeaders = [
                ["Doc Date", "Ref", "Account", "In", "In", "In", "In", "Out", "Out", "Out", "Out", "Balance", "Balance", "Balance", "Balance"],
                ["", "", "", "Pcs", "Weight", "Price / Unit", "Amount", "Pcs", "Weight", "Price / Unit", "Amount", "Pcs", "Weight", "Cost Price", "Cost Amount"]
            ];

            const itemRows = movementDetails.movements.map(item => [
            ...
            const summaryHeaders = ["Invoice No", "Lot No", "Stone", "Shape", "Size", "Color", "Cutting", "Clarity"];
            const summaryValues = [
                ...
                selectedItem.size,
                selectedItem.color,
                selectedItem.cutting,
                selectedItem.clarity
            ];

            exportConsignmentToExcel({
                filename: `Consignment Movement - ${selectedItem.invoice_no}`,
                sheetName: "Movement Details",
                summaryHeaders,
                summaryValues,
                itemHeaders,
                itemRows,
                merges: [
                    { s: { r: 2, c: 0 }, e: { r: 3, c: 0 } }, // Doc Date
                    { s: { r: 2, c: 1 }, e: { r: 3, c: 1 } }, // Ref
                    { s: { r: 2, c: 2 }, e: { r: 3, c: 2 } }, // Account
                    { s: { r: 2, c: 3 }, e: { r: 2, c: 6 } }, // In
                    { s: { r: 2, c: 7 }, e: { r: 2, c: 10 } }, // Out
                    { s: { r: 2, c: 11 }, e: { r: 2, c: 14 } }, // Balance
                ]
            });
    ...
    useEffect(() => {
        const fetchMovementDetails = async () => {
            ...
            try {
                setLoading(true);
                setError(null);
                const data = await getConsignmentMovementByInvoiceNo(selectedItem.invoice_no);
                    ...
                    <Box>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {selectedItem ? `${selectedItem.invoice_no}  ${selectedItem.lot_no}` : 'Consignment Movement Details'}
                                </Typography>
                                {selectedItem && (
                                    <Typography
                                        sx={{
                                            ...
                                            {movementDetails.movements.map((movement, index) => (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.in_price && movement.in_price !== 0 ? `${Number(movement.in_price).toLocaleString()} / pcs` : ""}
                                                        </Typography>
                                                    </Box>
                                                    <Box
                                                        sx={{
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.in_amount && movement.in_amount !== 0 ? Number(movement.in_amount).toLocaleString() : ""}
                                                        </Typography>
                                                    </Box>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.out_price && movement.out_price !== 0 ? `${Number(movement.out_price).toLocaleString()} / pcs` : ""}
                                                        </Typography>
                                                    </Box>
                                                    <Box
                                                        sx={{
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.out_amount && movement.out_amount !== 0 ? Number(movement.out_amount).toLocaleString() : ""}
                                                        </Typography>
                                                    </Box>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.stock_cost_price && movement.stock_cost_price !== 0 ? Number(movement.stock_cost_price).toLocaleString() : "-"}
                                                        </Typography>
                                                    </Box>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            {movement.stock_cost_amount && movement.stock_cost_amount !== 0 ? Number(movement.stock_cost_amount).toLocaleString() : "-"}
                                                        </Typography>
                                                    </Box>
                                    ...
                                    >
                                        <Box>
                                            ...
                                            >
                                                ...
                                                <Box sx={{ padding: "12px 8px", width: "124px" }}></Box>
                                                <Box sx={{ padding: "12px 8px", width: "124px" }}></Box>
                                                <Box
                                                    sx={{
                                                        padding: "12px 8px",
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {movementDetails.movements.length > 0 ? movementDetails.movements[movementDetails.movements.length - 1].balance_pcs : 0}
                                                    </Typography>
                                                </Box>
                                                <Box
                                                    sx={{
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {movementDetails.movements.length > 0 ? movementDetails.movements[movementDetails.movements.length - 1].balance_weight : 0}
                                                    </Typography>
                                                </Box>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        {movementDetails.movements.length > 0 ? Number(movementDetails.movements[movementDetails.movements.length - 1].stock_cost_price).toLocaleString() : "-"}
                                                    </Typography>
                                                </Box>
...
export default ConsignmentCheckBodyInside;
