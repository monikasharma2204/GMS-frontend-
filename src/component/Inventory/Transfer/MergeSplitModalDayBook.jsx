        ...
        >
          ...
          >
            ...
            >
              ...
              <Box sx={{ width: "286px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Typography sx={{ color: "var(--Main-Text, #343434)", fontFamily: "Calibri", fontSize: "16px", fontWeight: 700 }}>
                  Remark
                </Typography>
              </Box>
              ...
              sortedData.map((item, idx) => (
                ...
                >
                  ...
                  <Box sx={{ width: "120px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Box
                      sx={{
                        backgroundColor: item.status?.toLowerCase() === "approved" ? "#00AA3A33" : "#F4EEE1",
                  ...
                  <Box sx={{ width: "100px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Typography sx={{ color: "var(--Main-Text, #343434)", fontFamily: "Calibri", fontSize: "16px", fontWeight: 400 }}>
                      {(item.merge_and_split_items || []).reduce((sum, s) => sum + (Number(s.weight) || 0), 0).toFixed(3)}
                    </Typography>
                  </Box>

                  <Box sx={{ width: "100px", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Typography sx={{ color: "var(--Main-Text, #343434)", fontFamily: "Calibri", fontSize: "16px", fontWeight: 700 }}>
                      {formatNumberWithCommas((item.merge_and_split_items || []).reduce((sum, s) => sum + (Number(s.amount) || 0), 0).toFixed(2))}
                    </Typography>
                  </Box>
